...
/***/ function(module, exports, __webpack_require__) {
	...
	var _skycons = __webpack_require__(1);
	
	var _skycons2 = _interopRequireDefault(_skycons);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	// const Skycons = require('skycons/skycons')(window);
	var Skycons = (0, _skycons2.default)(window);
	var skycons = new Skycons({ "color": "#778287" });
	
	var googleGeocodingKey = 'AIzaSyDThdmlF6wBbpCKnwlTjE4PfwGH1PNOEjw';
	var forecastKey = 'fd04ff7341fc4b8ab8f77437a7c22c09';
	var city = void 0;
	var urls = [];
	var data = [];
	var darkSkyURL = void 0;
	var googleGeocodingURL = void 0;
	navigator.geolocation.getCurrentPosition(function (position) {
	    var _position$coords = position.coords;
	    var latitude = _position$coords.latitude;
	    var longitude = _position$coords.longitude;
	
	    darkSkyURL = "https://crossorigin.me/https://api.darksky.net/forecast/" + forecastKey + "/" + latitude + "," + longitude + "?units=ca";
	    googleGeocodingURL = "https://maps.googleapis.com/maps/api/geocode/json?latlng=" + latitude + "," + longitude + "&key=" + googleGeocodingKey;
	    ...
	    Promise.all([getWeather(darkSkyURL), getWeather(googleGeocodingURL)]).then(function (result) {
	        ...
	        location.innerHTML = result[1].results[1].address_components[0].long_name + ', ' + result[1].results[1].address_components[3].long_name;
	...
	toggler.onclick = function (e) {
	    ...
	    var prevEl = this.parentNode.previousElementSibling;
	    var nextEl = this.parentNode.nextElementSibling;
	    var temperature = document.querySelector('.temperature');
